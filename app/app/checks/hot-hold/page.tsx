...
export default async function HotHoldPage() {
  ...
  return <div className="p-4 sm:p-6 lg:p-8 max-w-5xl mx-auto"><ProcessCheckForm orgId={membership.organisation_id} userId={user.id} sites={sites ?? []} type="hot_hold" title="Hot-hold check" /></div>;
}
