...
export default async function CoolingPage() {
  ...
  return <div className="p-4 sm:p-6 lg:p-8 max-w-5xl mx-auto"><ProcessCheckForm orgId={membership.organisation_id} userId={user.id} sites={sites ?? []} type="cooling" title="Cooling check" /></div>;
}
