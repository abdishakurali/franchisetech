...
import { importCustomersCsv } from "@/app/actions/kitchenops";
...
const TEMPLATE = [
  HEADERS.join(","),
  "Jane Murphy,+353 87 000 0000,jane@example.ie,Regular customer",
].join("\n");
                ...
                <tbody>
                  {rows.slice(0, 10).map((r, i) => (
                    <tr key={i} className="border-b last:border-0">
                      ...
                      <td className="py-2 pr-3 text-slate-500">{r.phone}</td>
