      ...
      <div className="rounded-xl border border-slate-100 bg-white p-6">
        <div className="mb-4 flex items-start justify-between gap-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-slate-900">Delivery Records</h1>
              <p className="text-sm text-slate-500">Traceability report</p>
            </div>
          </div>
          <Badge variant="outline" className="bg-slate-100 text-slate-600 border-slate-200">Coming soon</Badge>
        </div>
        <p className="text-sm text-slate-600">
          Delivery records are planned. Fridge/freezer checks are working today.
        </p>
        <div className="mt-5">
