...
export function getAppReportLinks(t: AppT): AppReportLink[] {
  return [
    ...
    {
      href: "/app/reports/detalii-vanzari",
      title: t.reports.detaliiVanzari.title,
      desc: t.reports.detaliiVanzari.desc,
      icon: ListOrdered,
      color: "bg-indigo-50 text-indigo-700",
      tag: t.reports.detaliiVanzari.tag,
      requiresGestiune: true,
    },
    {
      href: "/app/reports/registru-de-casa",
      title: t.reports.registruDeCasa.title,
      desc: t.reports.registruDeCasa.desc,
      icon: Receipt,
      color: "bg-emerald-50 text-emerald-700",
      tag: t.reports.registruDeCasa.tag,
      requiresGestiune: true,
    },
    {
